    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-[0_8px_20px_rgba(0,0,0,0.08)]
      ...
      <div className="p-5">
        ...
        <div className="flex gap-3 mt-4">
          <button
            onClick={onReadMore}
            className="bg-[#ED9121] text-white px-5 py-2 rounded-full font-semibold cursor-pointer"
          >
            Read More
          </button>
          ...
          {youtubeUrl && (
            <button
              onClick={openVideo}
              className="border border-[#ED9121] text-[#ED9121] px-5 py-2 rounded-full font-semibold cursor-pointer"
            >
              Watch Video
            </button>
          )}
