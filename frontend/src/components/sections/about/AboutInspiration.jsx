        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-2xl lg:text-3   xl font-bold text-[#0B0B45] leading-tight">
                About Late Smt Sharada Kamath
              </h1>
            </div>

            {/* First paragraph */}
            <p className="text-[#0B0B45] text-base md:text-md leading-relaxed text-justify hyphens-auto">
